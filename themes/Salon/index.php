          ...
          <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <!-- <div class="item active">
                <a href=""><img src="<//?php bloginfo('template_url'); ?>/images/sotys-full.jpg" alt="..."></a>
              </div> -->
            <div class="item active">
                <a href=""><img src="<?php bloginfo('template_url'); ?>/images/slide3.jpg" alt="..."></a>
              </div>
              <div class="item">
                <a href=""><img src="<?php bloginfo('template_url'); ?>/images/slide4.jpg" alt="..."></a>
              </div>
              <div class="item">
